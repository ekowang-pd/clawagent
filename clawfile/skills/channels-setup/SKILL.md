...
1. If users are unsure how to configure channels, direct them to the Settings -> [User Manual](https://kimiclaw.feishu.cn/wiki/W2o6wf94ViOrLnklVsvcCB2CnPd) in KimiClaw Web for detailed instructions.
...
优先告诉用户可以用 KimiClaw 的一键接入功能快速接入企业微信智能机器人。路径为：点击 KimiClaw 设置按钮，找到「聊天频道」，点击
「+ 接入聊天软件」，选择「企业微信」即可。点击之后会弹出二维码，用户用企业微信扫码，可以快速创建企业微信智能机器人。
...
If users are unsure how to configure channels, direct them to the Settings -> [User Manual](https://kimiclaw.feishu.cn/wiki/W2o6wf94ViOrLnklVsvcCB2CnPd) in KimiClaw Web for detailed instructions.
